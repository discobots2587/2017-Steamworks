 ...
 */
public class AutonCenterPostBumpCommand extends CommandGroup {
    
    public  AutonCenterPostBumpCommand() {
        // Add Commands here:
        ...
        // arm.
    	addSequential(new AutonomousArcadeDrive(-.1,1.0,0300));//drops the gear mech
    	addSequential(new AutonomousArcadeDrive(0,-1.0,0100));//
    	addSequential(new WaitCommand(500));
    	addSequential(new AutonomousArcadeDrive(-0.15,0.6,1500));
