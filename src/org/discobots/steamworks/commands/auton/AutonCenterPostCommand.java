...
public class AutonCenterPostCommand extends CommandGroup {
    ...
    public  AutonCenterPostCommand() {
    	...
    	addSequential(new AutonomousArcadeDrive(0.1,0.5,3000));
    	addSequential(new edu.wpi.first.wpilibj.command.WaitCommand(3));
    	addSequential(new AutonomousArcadeDrive(-0.2, -0.6,	1000));//backup 
    	addSequential(new AutonomousArcadeDrive(0.15,0.55, 2500));
    	addSequential(new AutonomousArcadeDrive(-0.15,-0.4,1000));
